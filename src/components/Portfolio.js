...
import imgPort8 from '../images/port8.png';
  ...
  useEffect(() => {
    if (!openModal) {
      setPortfolio([
        ...
        {
          clicked: false,
          title: 'Personal Trainers Booking tool',
          image: imgPort8,
          description:
            'Manager tool for personal trainers. Can be used to schedule, track and register trainings and users. Also a PT can track the incomes.',
          link: 'https://smart-cprs.onrender.com',
          icons: [html, css, js, react, node, express, mongo],
        },
      ]);
    }
  }, [openModal]);
